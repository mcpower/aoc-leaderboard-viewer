...
var _Bractlet$elm_plot$Internal_Colors$darkGrey = '#a3a3a3';
var _Bractlet$elm_plot$Internal_Colors$grey = '#e3e3e3';
var _Bractlet$elm_plot$Internal_Colors$transparent = 'transparent';
var _Bractlet$elm_plot$Internal_Colors$blueStroke = '#cfd8ea';
var _Bractlet$elm_plot$Internal_Colors$blueFill = '#e4eeff';
var _Bractlet$elm_plot$Internal_Colors$pinkStroke = '#ff9edf';
var _Bractlet$elm_plot$Internal_Colors$pinkFill = 'rgba(253, 185, 231, 0.5)';
...
var _Bractlet$elm_plot$Internal_Draw$sign = function (x) {
	return (_elm_lang$core$Native_Utils.cmp(x, 0) < 0) ? -1 : 1;
};
var _Bractlet$elm_plot$Internal_Draw$slope2 = F3(
	function (point0, point1, t) {
		var h = point1.x - point0.x;
		return (!_elm_lang$core$Native_Utils.eq(h, 0)) ? ((((3 * (point1.y - point0.y)) / h) - t) / 2) : t;
	});
var _Bractlet$elm_plot$Internal_Draw$toH = F2(
	function (h0, h1) {
		return _elm_lang$core$Native_Utils.eq(h0, 0) ? ((_elm_lang$core$Native_Utils.cmp(h1, 0) < 0) ? (0 * -1) : h1) : h0;
	});
var _Bractlet$elm_plot$Internal_Draw$slope3 = F3(
	function (point0, point1, point2) {
		var h1 = point2.x - point1.x;
		var h0 = point1.x - point0.x;
		var s0h = A2(_Bractlet$elm_plot$Internal_Draw$toH, h0, h1);
		var s0 = (point1.y - point0.y) / s0h;
		var s1h = A2(_Bractlet$elm_plot$Internal_Draw$toH, h1, h0);
		var s1 = (point2.y - point1.y) / s1h;
		var p = ((s0 * h1) + (s1 * h0)) / (h0 + h1);
		var slope = (_Bractlet$elm_plot$Internal_Draw$sign(s0) + _Bractlet$elm_plot$Internal_Draw$sign(s1)) * A2(
...
var _Bractlet$elm_plot$Internal_Draw$boolToString = function (bool) {
	return bool ? '0' : '1';
};
var _Bractlet$elm_plot$Internal_Draw$pointToString = function (_p0) {
	var _p1 = _p0;
	return A2(
...
var _Bractlet$elm_plot$Internal_Draw$pointsToString = function (points) {
	return A2(
		_elm_lang$core$String$join,
		',',
		A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Internal_Draw$pointToString, points));
};
var _Bractlet$elm_plot$Internal_Draw$joinCommands = function (commands) {
	return A2(_elm_lang$core$String$join, ' ', commands);
};
var _Bractlet$elm_plot$Internal_Draw$yClosestToZero = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3.y;
	return A3(_elm_lang$core$Basics$clamp, _p4.min, _p4.max, 0);
};
var _Bractlet$elm_plot$Internal_Draw$length = function (axis) {
	return (axis.length - axis.marginLower) - axis.marginUpper;
};
var _Bractlet$elm_plot$Internal_Draw$range = function (axis) {
	return (!_elm_lang$core$Native_Utils.eq(axis.max - axis.min, 0)) ? (axis.max - axis.min) : 1;
};
var _Bractlet$elm_plot$Internal_Draw$scaleValue = F2(
	function (axis, value) {
		return (value * _Bractlet$elm_plot$Internal_Draw$length(axis)) / _Bractlet$elm_plot$Internal_Draw$range(axis);
	});
var _Bractlet$elm_plot$Internal_Draw$toSVGX = F2(
	function (_p5, value) {
		var _p6 = _p5;
		var _p7 = _p6.x;
		return A2(_Bractlet$elm_plot$Internal_Draw$scaleValue, _p7, value - _p7.min) + _p7.marginLower;
	});
var _Bractlet$elm_plot$Internal_Draw$toSVGY = F2(
	function (_p8, value) {
		var _p9 = _p8;
		var _p10 = _p9.y;
		return A2(_Bractlet$elm_plot$Internal_Draw$scaleValue, _p10, _p10.max - value) + _p10.marginLower;
	});
var _Bractlet$elm_plot$Internal_Draw$place = F4(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(
						A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p12.x) + offsetX),
					A2(
						_elm_lang$core$Basics_ops['++'],
						',',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(
								A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p12.y) + offsetY),
							')')))));
	});
var _Bractlet$elm_plot$Internal_Draw$unScaleValue = F2(
	function (axis, v) {
		return (v * _Bractlet$elm_plot$Internal_Draw$range(axis)) / _Bractlet$elm_plot$Internal_Draw$length(axis);
	});
var _Bractlet$elm_plot$Internal_Draw$toUnSVGX = F2(
	function (_p13, value) {
		var _p14 = _p13;
		var _p15 = _p14.x;
		return A2(_Bractlet$elm_plot$Internal_Draw$unScaleValue, _p15, value - _p15.marginLower) + _p15.min;
	});
var _Bractlet$elm_plot$Internal_Draw$toUnSVGY = F2(
	function (_p16, value) {
		var _p17 = _p16;
		var _p18 = _p17.y;
		return (_Bractlet$elm_plot$Internal_Draw$range(_p18) - A2(_Bractlet$elm_plot$Internal_Draw$unScaleValue, _p18, value - _p18.marginLower)) + _p18.min;
	});
var _Bractlet$elm_plot$Internal_Draw$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _Bractlet$elm_plot$Internal_Draw$stringifyCommand = function (command) {
	var _p19 = command;
	switch (_p19.ctor) {
		case 'Move':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'M',
				_Bractlet$elm_plot$Internal_Draw$pointToString(
					A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._0, _p19._1)));
		case 'Line':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'L',
		...
		case 'CubicBeziers':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'C',
				_Bractlet$elm_plot$Internal_Draw$pointsToString(
					{
						ctor: '::',
						_0: A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._0, _p19._1),
						_1: {
							ctor: '::',
							_0: A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._2, _p19._3),
							_1: {
								ctor: '::',
								_0: A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._4, _p19._5),
								_1: {ctor: '[]'}
							}
						}
					}));
		...
		case 'Arc':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'A',
				_Bractlet$elm_plot$Internal_Draw$joinCommands(
					{
						ctor: '::',
						_0: _Bractlet$elm_plot$Internal_Draw$pointToString(
							A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._0, _p19._1)),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _Bractlet$elm_plot$Internal_Draw$boolToString(_p19._3),
								_1: {
									ctor: '::',
									_0: _Bractlet$elm_plot$Internal_Draw$boolToString(_p19._4),
									_1: {
										ctor: '::',
										_0: _Bractlet$elm_plot$Internal_Draw$pointToString(
											A2(_Bractlet$elm_plot$Internal_Draw$Point, _p19._5, _p19._6)),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _Bractlet$elm_plot$Internal_Draw$draw = F2(
		...
		return A2(
			_elm_lang$svg$Svg$path,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$d(
					_Bractlet$elm_plot$Internal_Draw$joinCommands(
						A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Internal_Draw$stringifyCommand, commands))),
				_1: attributes
			},
			{ctor: '[]'});
	});
var _Bractlet$elm_plot$Internal_Draw$AxisSummary = F8(
	function (a, b, c, d, e, f, g, h) {
		return {min: a, max: b, dataMin: c, dataMax: d, marginLower: e, marginUpper: f, length: g, all: h};
	});
var _Bractlet$elm_plot$Internal_Draw$PlotSummary = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _Bractlet$elm_plot$Internal_Draw$Close = {ctor: 'Close'};
var _Bractlet$elm_plot$Internal_Draw$Arc = F7(
	function (a, b, c, d, e, f, g) {
		return {ctor: 'Arc', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f, _6: g};
	});
var _Bractlet$elm_plot$Internal_Draw$QuadraticBeziersShort = F2(
	function (a, b) {
		return {ctor: 'QuadraticBeziersShort', _0: a, _1: b};
	});
var _Bractlet$elm_plot$Internal_Draw$QuadraticBeziers = F4(
	function (a, b, c, d) {
		return {ctor: 'QuadraticBeziers', _0: a, _1: b, _2: c, _3: d};
	});
var _Bractlet$elm_plot$Internal_Draw$CubicBeziersShort = F4(
	function (a, b, c, d) {
		return {ctor: 'CubicBeziersShort', _0: a, _1: b, _2: c, _3: d};
	});
var _Bractlet$elm_plot$Internal_Draw$CubicBeziers = F6(
	function (a, b, c, d, e, f) {
		return {ctor: 'CubicBeziers', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f};
	});
var _Bractlet$elm_plot$Internal_Draw$monotoneXCurve = F4(
	function (point0, point1, tangent0, tangent1) {
		var dx = (point1.x - point0.x) / 3;
		return {
			ctor: '::',
			_0: A6(_Bractlet$elm_plot$Internal_Draw$CubicBeziers, point0.x + dx, point0.y + (dx * tangent0), point1.x - dx, point1.y - (dx * tangent1), point1.x, point1.y),
			_1: {ctor: '[]'}
		};
	});
var _Bractlet$elm_plot$Internal_Draw$monotoneXNext = F3(
		...
		while (true) {
			...
			if ((_p20.ctor === '::') && (_p20._1.ctor === '::')) {
				if (_p20._1._1.ctor === '::') {
					...
					var _p22 = _p20._1._0;
					var _p21 = _p20._0;
					var tangent1 = A3(_Bractlet$elm_plot$Internal_Draw$slope3, _p21, _p22, _p23);
					var nextCommands = A2(
						_elm_lang$core$Basics_ops['++'],
						commands,
						A4(_Bractlet$elm_plot$Internal_Draw$monotoneXCurve, _p21, _p22, tangent0, tangent1));
					var _v9 = {
						ctor: '::',
						_0: _p22,
					...
					var _p25 = _p20._1._0;
					var _p24 = _p20._0;
					var tangent1 = A3(_Bractlet$elm_plot$Internal_Draw$slope3, _p24, _p25, _p25);
					return A2(
						_elm_lang$core$Basics_ops['++'],
						commands,
						A4(_Bractlet$elm_plot$Internal_Draw$monotoneXCurve, _p24, _p25, tangent0, tangent1));
				}
			} else {
				return commands;
			}
...
var _Bractlet$elm_plot$Internal_Draw$monotoneXBegin = function (points) {
	var _p26 = points;
	if (((_p26.ctor === '::') && (_p26._1.ctor === '::')) && (_p26._1._1.ctor === '::')) {
		var _p29 = _p26._1._1._0;
		var _p28 = _p26._1._0;
		var _p27 = _p26._0;
		var tangent1 = A3(_Bractlet$elm_plot$Internal_Draw$slope3, _p27, _p28, _p29);
		var tangent0 = A3(_Bractlet$elm_plot$Internal_Draw$slope2, _p27, _p28, tangent1);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A4(_Bractlet$elm_plot$Internal_Draw$monotoneXCurve, _p27, _p28, tangent0, tangent1),
			A3(
				_Bractlet$elm_plot$Internal_Draw$monotoneXNext,
				{
					ctor: '::',
					_0: _p28,
...
var _Bractlet$elm_plot$Internal_Draw$VerticalLine = function (a) {
	return {ctor: 'VerticalLine', _0: a};
};
var _Bractlet$elm_plot$Internal_Draw$HorizontalLine = function (a) {
	return {ctor: 'HorizontalLine', _0: a};
};
var _Bractlet$elm_plot$Internal_Draw$Line = F2(
	function (a, b) {
		return {ctor: 'Line', _0: a, _1: b};
	});
var _Bractlet$elm_plot$Internal_Draw$lineCommand = function (_p30) {
	var _p31 = _p30;
	return A2(_Bractlet$elm_plot$Internal_Draw$Line, _p31.x, _p31.y);
};
var _Bractlet$elm_plot$Internal_Draw$areaEnd = F2(
	function (plot, points) {
		...
		if (_p32.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A2(
					_Bractlet$elm_plot$Internal_Draw$Line,
					_p32._0.x,
					_Bractlet$elm_plot$Internal_Draw$yClosestToZero(plot)),
				_1: {ctor: '[]'}
			};
		} else {
			return {ctor: '[]'};
...
var _Bractlet$elm_plot$Internal_Draw$Move = F2(
	function (a, b) {
		return {ctor: 'Move', _0: a, _1: b};
	});
var _Bractlet$elm_plot$Internal_Draw$lineBegin = F2(
	function (plot, points) {
		var _p33 = points;
		if (_p33.ctor === '::') {
			return {
				ctor: '::',
				_0: A2(_Bractlet$elm_plot$Internal_Draw$Move, _p33._0.x, _p33._0.y),
				_1: {ctor: '[]'}
			};
		} else {
			return {ctor: '[]'};
...
var _Bractlet$elm_plot$Internal_Draw$areaBegin = F2(
	function (plot, points) {
		var _p34 = points;
		if (_p34.ctor === '::') {
			var _p35 = _p34._0.x;
			return {
				ctor: '::',
				_0: A2(
					_Bractlet$elm_plot$Internal_Draw$Move,
					_p35,
					_Bractlet$elm_plot$Internal_Draw$yClosestToZero(plot)),
				_1: {
					ctor: '::',
					_0: A2(_Bractlet$elm_plot$Internal_Draw$Line, _p35, _p34._0.y),
					_1: {ctor: '[]'}
				}
			};
		} else {
...
var _Bractlet$elm_plot$Internal_Draw$translateCommand = F2(
	function (plot, command) {
		...
		switch (_p36.ctor) {
			case 'Move':
				return A2(
					_Bractlet$elm_plot$Internal_Draw$Move,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1));
			case 'Line':
				return A2(
					_Bractlet$elm_plot$Internal_Draw$Line,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1));
			case 'HorizontalLine':
				return _Bractlet$elm_plot$Internal_Draw$HorizontalLine(
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0));
			case 'VerticalLine':
				return _Bractlet$elm_plot$Internal_Draw$VerticalLine(
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._0));
			case 'CubicBeziers':
				return A6(
					_Bractlet$elm_plot$Internal_Draw$CubicBeziers,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._2),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._3),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._4),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._5));
			case 'CubicBeziersShort':
				return A4(
					_Bractlet$elm_plot$Internal_Draw$CubicBeziersShort,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._2),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._3));
			case 'QuadraticBeziers':
				return A4(
					_Bractlet$elm_plot$Internal_Draw$QuadraticBeziers,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._2),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._3));
			case 'QuadraticBeziersShort':
				return A2(
					_Bractlet$elm_plot$Internal_Draw$QuadraticBeziersShort,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1));
			case 'Arc':
				return A7(
					_Bractlet$elm_plot$Internal_Draw$Arc,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._0),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._1),
					_p36._2,
					_p36._3,
					_p36._4,
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, plot, _p36._5),
					A2(_Bractlet$elm_plot$Internal_Draw$toSVGY, plot, _p36._6));
			default:
				return _Bractlet$elm_plot$Internal_Draw$Close;
		}
	});
var _Bractlet$elm_plot$Internal_Draw$linear = F2(
	function (plot, points) {
		return A2(
			_elm_lang$core$List$map,
			_Bractlet$elm_plot$Internal_Draw$translateCommand(plot),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_Bractlet$elm_plot$Internal_Draw$lineBegin, plot, points),
				A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Internal_Draw$lineCommand, points)));
	});
var _Bractlet$elm_plot$Internal_Draw$linearArea = F2(
	function (plot, points) {
		return A2(
			_elm_lang$core$List$map,
			_Bractlet$elm_plot$Internal_Draw$translateCommand(plot),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_Bractlet$elm_plot$Internal_Draw$areaBegin, plot, points),
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Internal_Draw$lineCommand, points),
					A2(_Bractlet$elm_plot$Internal_Draw$areaEnd, plot, points))));
	});
var _Bractlet$elm_plot$Internal_Draw$monotoneX = F2(
	function (plot, points) {
		return A2(
			_elm_lang$core$List$map,
			_Bractlet$elm_plot$Internal_Draw$translateCommand(plot),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_Bractlet$elm_plot$Internal_Draw$lineBegin, plot, points),
				_Bractlet$elm_plot$Internal_Draw$monotoneXBegin(points)));
	});
var _Bractlet$elm_plot$Internal_Draw$monotoneXArea = F2(
	function (plot, points) {
		return A2(
			_elm_lang$core$List$map,
			_Bractlet$elm_plot$Internal_Draw$translateCommand(plot),
...
var _Bractlet$elm_plot$Plot$point = function (_p0) {
	var _p1 = _p0;
	return A2(_Bractlet$elm_plot$Internal_Draw$Point, _p1.x, _p1.y);
};
var _Bractlet$elm_plot$Plot$points = _elm_lang$core$List$map(_Bractlet$elm_plot$Plot$point);
var _Bractlet$elm_plot$Plot$niceInterval = F3(
...
var _Bractlet$elm_plot$Plot$count = F4(
...
var _Bractlet$elm_plot$Plot$ceilToNearest = F2(
	function (precision, value) {
		return _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$ceiling(value / precision)) * precision;
	});
var _Bractlet$elm_plot$Plot$firstValue = F2(
	function (delta, lowest) {
		return A2(_Bractlet$elm_plot$Plot$ceilToNearest, delta, lowest);
	});
var _Bractlet$elm_plot$Plot$deltaPrecision = function (delta) {
...
var _Bractlet$elm_plot$Plot$tickPosition = F3(
		...
		return A2(
			...
			_elm_lang$core$String$toFloat(
				A2(
					...
					_Bractlet$elm_plot$Plot$deltaPrecision(delta),
					firstValue + (_elm_lang$core$Basics$toFloat(index) * delta))));
	});
var _Bractlet$elm_plot$Plot$remove = F2(
...
var _Bractlet$elm_plot$Plot$interval = F3(
	function (offset, delta, _p2) {
		var _p3 = _p2;
		var _p4 = _p3.min;
		var value = A2(_Bractlet$elm_plot$Plot$firstValue, delta, _p4) + offset;
		var range = _elm_lang$core$Basics$abs(_p4 - _p3.max);
		var indexes = A2(
			_elm_lang$core$List$range,
			0,
			A4(_Bractlet$elm_plot$Plot$count, delta, _p4, range, value));
		return A2(
			_elm_lang$core$List$map,
			A2(_Bractlet$elm_plot$Plot$tickPosition, delta, value),
			indexes);
	});
var _Bractlet$elm_plot$Plot$decentPositions = function (summary) {
	return (_elm_lang$core$Native_Utils.cmp(summary.length, 600) > 0) ? A3(
		_Bractlet$elm_plot$Plot$interval,
		0,
		A3(_Bractlet$elm_plot$Plot$niceInterval, summary.min, summary.max, 10),
		summary) : A3(
		_Bractlet$elm_plot$Plot$interval,
		0,
		A3(_Bractlet$elm_plot$Plot$niceInterval, summary.min, summary.max, 5),
		summary);
};
var _Bractlet$elm_plot$Plot$viewLabel = F2(
...
var _Bractlet$elm_plot$Plot$viewTickInner = F3(
...
var _Bractlet$elm_plot$Plot$viewAxisLine = F3(
	function (summary, at, axisLine) {
		var _p5 = axisLine;
		if (_p5.ctor === 'Just') {
			return A2(
				_Bractlet$elm_plot$Internal_Draw$draw,
				_p5._0.attributes,
				A2(
					_Bractlet$elm_plot$Internal_Draw$linear,
					summary,
					{
						ctor: '::',
						_0: at(_p5._0.start),
...
var _Bractlet$elm_plot$Plot$viewGlitterLines = F2(
	function (summary, _p6) {
		var _p7 = _p6;
		return {
			ctor: '::',
			_0: A3(
				_Bractlet$elm_plot$Plot$viewAxisLine,
				summary,
				function (y) {
					return {x: _p7.x, y: y};
				},
...
var _Bractlet$elm_plot$Plot$viewActualVerticalAxis = F3(
	function (summary, _p8, glitterTicks) {
		...
		var viewTickLine = function (_p10) {
			...
			return A2(
				_elm_lang$svg$Svg$g,
				{
					ctor: '::',
					_0: A4(
						_Bractlet$elm_plot$Internal_Draw$place,
						summary,
						at(_p11.position),
						0,
						0),
				...
				},
				{
					ctor: '::',
					_0: A3(
						_Bractlet$elm_plot$Plot$viewTickInner,
						_p11.attributes,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_Bractlet$elm_plot$Plot$viewAxisLine, summary, at, _p9.axisLine),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
...
var _Bractlet$elm_plot$Plot$viewVerticalAxis = F3(
		...
		if (_p15.ctor === 'Axis') {
			return _elm_lang$core$Maybe$Just(
				A2(
					...
					A3(
						_Bractlet$elm_plot$Plot$viewActualVerticalAxis,
						summary,
						_p15._0(summary.y),
						moreTicks)));
		} else {
...
var _Bractlet$elm_plot$Plot$viewActualHorizontalAxis = F4(
	function (summary, _p16, glitterLabels, glitterTicks) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_Bractlet$elm_plot$Plot$viewAxisLine, summary, at, _p17.axisLine),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
...
var _Bractlet$elm_plot$Plot$viewHorizontalAxis = F4(
		...
		if (_p23.ctor === 'Axis') {
			return _elm_lang$core$Maybe$Just(
				A2(
					...
					_elm_lang$core$Basics$never,
					A4(
						_Bractlet$elm_plot$Plot$viewActualHorizontalAxis,
						summary,
						_p23._0(summary.x),
						moreLabels,
						moreTicks)));
...
var _Bractlet$elm_plot$Plot$viewTriangle = function (color) {
	return A2(
...
var _Bractlet$elm_plot$Plot$viewDiamond = F3(
...
var _Bractlet$elm_plot$Plot$viewSquare = F2(
...
var _Bractlet$elm_plot$Plot$viewCircle = F2(
...
var _Bractlet$elm_plot$Plot$viewDataPoint = F2(
...
var _Bractlet$elm_plot$Plot$viewDataPoints = F2(
	function (plotSummary, dataPoints) {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_Bractlet$elm_plot$Plot$viewDataPoint(plotSummary),
					dataPoints)));
	});
var _Bractlet$elm_plot$Plot$viewActualHorizontalGrid = F2(
...
var _Bractlet$elm_plot$Plot$viewHorizontalGrid = F2(
		...
		if (_p30.ctor === 'Grid') {
			return _elm_lang$core$Maybe$Just(
				A2(
					...
					_elm_lang$core$Basics$never,
					A2(
						_Bractlet$elm_plot$Plot$viewActualHorizontalGrid,
						summary,
						_p30._0(summary.y))));
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _Bractlet$elm_plot$Plot$viewActualVerticalGrid = F2(
	function (summary, gridLines) {
...
var _Bractlet$elm_plot$Plot$viewVerticalGrid = F2(
	function (summary, grid) {
		var _p34 = grid;
		if (_p34.ctor === 'Grid') {
			return _elm_lang$core$Maybe$Just(
				A2(
					...
					_elm_lang$core$Basics$never,
					A2(
						_Bractlet$elm_plot$Plot$viewActualVerticalGrid,
						summary,
						_p34._0(summary.x))));
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _Bractlet$elm_plot$Plot$defaultPlotSummary = {
	x: {
		min: 0.0,
		max: 1.0,
		all: {ctor: '[]'}
...
var _Bractlet$elm_plot$Plot$toPlotSummary = F3(
	function (customizations, toNiceReach, points) {
		...
		var plotSummary = toNiceReach(
			A2(
				_elm_lang$core$Maybe$withDefault,
				_Bractlet$elm_plot$Plot$defaultPlotSummary,
...
var _Bractlet$elm_plot$Plot$diff = F2(
	function (a, b) {
		return _elm_lang$core$Basics$abs(a - b);
	});
var _Bractlet$elm_plot$Plot$toNearestX = F2(
	function (summary, exactX) {
		var updateIfCloser = F2(
			function (closest, x) {
				return (_elm_lang$core$Native_Utils.cmp(
					A2(_Bractlet$elm_plot$Plot$diff, x, exactX),
					A2(_Bractlet$elm_plot$Plot$diff, closest, exactX)) > 0) ? closest : x;
			});
		var $default = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
...
var _Bractlet$elm_plot$Plot$unScalePoint = F4(
	function (summary, mouseX, mouseY, _p41) {
		var _p42 = _p41;
		return _elm_lang$core$Maybe$Just(
			{
				x: A2(
					_Bractlet$elm_plot$Plot$toNearestX,
					summary,
					A2(_Bractlet$elm_plot$Internal_Draw$toUnSVGX, summary, (summary.x.length * (mouseX - _p42.left)) / _p42.width)),
				y: A3(
					_elm_lang$core$Basics$clamp,
					summary.y.min,
					summary.y.max,
					A2(_Bractlet$elm_plot$Internal_Draw$toUnSVGY, summary, (summary.y.length * (mouseY - _p42.top)) / _p42.height))
			});
	});
var _Bractlet$elm_plot$Plot$boundingPositionIfNotSvg = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (namespace) {
		return (!_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$toLower(namespace),
			'http://www.w3.org/2000/svg')) ? _debois$elm_dom$DOM$boundingClientRect : _elm_lang$core$Json_Decode$fail('inside svg yet');
	},
	A2(_elm_lang$core$Json_Decode$field, 'namespaceURI', _elm_lang$core$Json_Decode$string));
var _Bractlet$elm_plot$Plot$plotPosition = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: _Bractlet$elm_plot$Plot$boundingPositionIfNotSvg,
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Json_Decode$lazy(
				function (_p43) {
					return _debois$elm_dom$DOM$parentElement(_Bractlet$elm_plot$Plot$plotPosition);
				}),
			_1: {ctor: '[]'}
		}
	});
var _Bractlet$elm_plot$Plot$handleHint = F2(
	function (summary, toMsg) {
		return A4(
			...
			F3(
				function (x, y, r) {
					return toMsg(
						A4(_Bractlet$elm_plot$Plot$unScalePoint, summary, x, y, r));
				}),
			...
			_debois$elm_dom$DOM$target(_Bractlet$elm_plot$Plot$plotPosition));
	});
var _Bractlet$elm_plot$Plot$viewActualJunk = F2(
...
var _Bractlet$elm_plot$Plot$innerAttributes = function (customizations) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _Bractlet$elm_plot$Plot$containerAttributes = F2(
		...
		if (_p46.ctor === 'Just') {
			...
			return {
				...
				_0: A2(
					_elm_lang$html$Html_Events$on,
					'mousemove',
					A2(_Bractlet$elm_plot$Plot$handleHint, summary, _p47)),
				_1: {
					ctor: '::',
...
var _Bractlet$elm_plot$Plot$toClipPathId = function (_p48) {
	var _p49 = _p48;
	return A2(_elm_lang$core$Basics_ops['++'], 'elm-plot__clip-path__', _p49.id);
};
var _Bractlet$elm_plot$Plot$viewInterpolation = F7(
	function (customizations, summary, toLine, toArea, area, attributes, dataPoints) {
		...
		if (_p50.ctor === 'Nothing') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fill(_Bractlet$elm_plot$Internal_Colors$transparent),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$pinkStroke),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$clipPath(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_Bractlet$elm_plot$Plot$toClipPathId(customizations),
											')'))),
								_1: attributes
							}
						}
				...
				A2(
					toLine,
					summary,
					_Bractlet$elm_plot$Plot$points(dataPoints)));
		} else {
			return A2(
				_Bractlet$elm_plot$Internal_Draw$draw,
				{
...
var _Bractlet$elm_plot$Plot$viewPath = F4(
		...
		switch (_p51.ctor) {
			case 'None':
				return A2(
					...
					{ctor: '[]'});
			case 'Linear':
				return A7(_Bractlet$elm_plot$Plot$viewInterpolation, customizations, plotSummary, _Bractlet$elm_plot$Internal_Draw$linear, _Bractlet$elm_plot$Internal_Draw$linearArea, _p51._0, _p51._1, dataPoints);
			default:
				return A7(_Bractlet$elm_plot$Plot$viewInterpolation, customizations, plotSummary, _Bractlet$elm_plot$Internal_Draw$monotoneX, _Bractlet$elm_plot$Internal_Draw$monotoneXArea, _p51._0, _p51._1, dataPoints);
		}
	});
var _Bractlet$elm_plot$Plot$viewASeries = F4(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$map,
					_elm_lang$core$Basics$never,
					A4(_Bractlet$elm_plot$Plot$viewPath, customizations, plotSummary, _p53.interpolation, dataPoints)),
				_1: {
					ctor: '::',
					_0: A2(_Bractlet$elm_plot$Plot$viewDataPoints, plotSummary, dataPoints),
					_1: {ctor: '[]'}
				}
			});
	});
var _Bractlet$elm_plot$Plot$defineClipPath = F2(
	function (customizations, summary) {
		return A2(
							...
							_elm_lang$svg$Svg$rect,
							{
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$svg$Svg_Attributes$width(
											_elm_lang$core$Basics$toString(
												_Bractlet$elm_plot$Internal_Draw$length(summary.x))),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$height(
												_elm_lang$core$Basics$toString(
													_Bractlet$elm_plot$Internal_Draw$length(summary.y))),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _Bractlet$elm_plot$Plot$addNiceReachForBars = function (_p54) {
	var _p55 = _p54;
	var _p57 = _p55.y;
	var _p56 = _p55.x;
...
var _Bractlet$elm_plot$Plot$addNiceReachForArea = F2(
	function (area, _p58) {
		var _p59 = _p58;
		var _p62 = _p59.y;
		var _p61 = _p59;
...
var _Bractlet$elm_plot$Plot$addNiceReachForSeries = function (series) {
	var _p63 = series.interpolation;
	switch (_p63.ctor) {
		case 'None':
			return _elm_lang$core$Basics$identity;
		case 'Linear':
			return _Bractlet$elm_plot$Plot$addNiceReachForArea(_p63._0);
		default:
			return _Bractlet$elm_plot$Plot$addNiceReachForArea(_p63._0);
	}
};
var _Bractlet$elm_plot$Plot$viewSeriesCustom = F3(
	function (customizations, series, data) {
		var addNiceReach = function (summary) {
			return A3(_elm_lang$core$List$foldl, _Bractlet$elm_plot$Plot$addNiceReachForSeries, summary, series);
		};
		var dataPoints = A2(
			_elm_lang$core$List$map,
			function (_p64) {
		...
		var summary = A3(_Bractlet$elm_plot$Plot$toPlotSummary, customizations, addNiceReach, allDataPoints);
		var viewJunks = _elm_lang$core$Maybe$Just(
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_Bractlet$elm_plot$Plot$viewActualJunk(summary),
					customizations.junk(summary))));
		var viewHorizontalAxes = A4(
			_Bractlet$elm_plot$Plot$viewHorizontalAxis,
			summary,
			...
			A2(
				...
				A2(
					...
					A2(
						...
						_Bractlet$elm_plot$Plot$viewGlitterLines(summary),
						allDataPoints))));
			...
			A2(
				...
				A2(
					...
					A3(
						...
						function (_p67) {
							return A2(
								_Bractlet$elm_plot$Plot$viewVerticalAxis,
								summary,
								function (_) {
									return _.axis;
								}(_p67));
		...
		var viewActualSeries = _elm_lang$core$Maybe$Just(
			A2(
				...
				A3(
					_elm_lang$core$List$map2,
					A2(_Bractlet$elm_plot$Plot$viewASeries, customizations, summary),
					series,
					dataPoints)));
		var children = A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
			{
				...
				_0: _elm_lang$core$Maybe$Just(
					A2(_Bractlet$elm_plot$Plot$defineClipPath, customizations, summary)),
				_1: {
					ctor: '::',
					_0: A2(_Bractlet$elm_plot$Plot$viewHorizontalGrid, summary, customizations.grid.horizontal),
					_1: {
						ctor: '::',
						_0: A2(_Bractlet$elm_plot$Plot$viewVerticalGrid, summary, customizations.grid.vertical),
						_1: {
							ctor: '::',
							_0: viewActualSeries,
							_1: {
		...
		return A2(
			...
			A2(_Bractlet$elm_plot$Plot$containerAttributes, customizations, summary),
			{
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$svg,
					_Bractlet$elm_plot$Plot$innerAttributes(customizations),
					children),
				_1: {
					ctor: '::',
					_0: viewHint,
...
var _Bractlet$elm_plot$Plot$closestToZero = F2(
	function (min, max) {
		return A3(_elm_lang$core$Basics$clamp, min, max, 0);
	});
var _Bractlet$elm_plot$Plot$viewActualBars = F3(
	function (summary, _p68, groups) {
		...
		var width = function () {
			...
			if (_p70.ctor === 'Percentage') {
				...
				return (_elm_lang$core$Native_Utils.cmp(
					defaultWidth,
					A2(_Bractlet$elm_plot$Internal_Draw$unScaleValue, summary.x, _p71)) > 0) ? A2(_Bractlet$elm_plot$Internal_Draw$unScaleValue, summary.x, _p71) : defaultWidth;
			}
		}();
					...
					_0: _elm_lang$svg$Svg_Attributes$transform(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(
									A2(_Bractlet$elm_plot$Internal_Draw$scaleValue, summary.x, width / 2)),
								', -5)'))),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$style('text-anchor: middle;'),
						...
						_0: A4(
							...
							summary,
							{
								...
								y: A2(
									...
									A2(_Bractlet$elm_plot$Plot$closestToZero, summary.y.min, summary.y.max),
									_p74)
							},
							0,
							0),
							...
							_0: A2(
								...
								A2(
									...
									attributes,
									{
										...
										_0: _elm_lang$svg$Svg_Attributes$width(
											_elm_lang$core$Basics$toString(
												A2(_Bractlet$elm_plot$Internal_Draw$scaleValue, summary.x, width))),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$height(
												_elm_lang$core$Basics$toString(
													A2(
														_Bractlet$elm_plot$Internal_Draw$scaleValue,
														summary.y,
...
var _Bractlet$elm_plot$Plot$viewBarsCustom = F3(
	function (customizations, bars, data) {
		...
		var summary = A3(_Bractlet$elm_plot$Plot$toPlotSummary, customizations, _Bractlet$elm_plot$Plot$addNiceReachForBars, dataPoints);
		var viewGlitter = _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$svg$Svg$map,
				_elm_lang$core$Basics$never,
			...
			_elm_lang$core$Basics$identity,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A3(_Bractlet$elm_plot$Plot$viewActualBars, summary, bars, groups),
							_1: {
								ctor: '::',
								_0: A4(
									_Bractlet$elm_plot$Plot$viewHorizontalAxis,
...
var _Bractlet$elm_plot$Plot$displace = F2(
	function (x, y) {
		return _elm_lang$svg$Svg_Attributes$transform(
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _Bractlet$elm_plot$Plot$fullLine = F2(
...
var _Bractlet$elm_plot$Plot$simpleLabel = function (position) {
	return {
		position: position,
		view: A2(
			_Bractlet$elm_plot$Plot$viewLabel,
			{ctor: '[]'},
			_elm_lang$core$Basics$toString(position))
	};
};
var _Bractlet$elm_plot$Plot$simpleTick = function (position) {
	return {
		position: position,
		length: 5,
		attributes: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$darkGrey),
			_1: {ctor: '[]'}
		}
	};
};
var _Bractlet$elm_plot$Plot$simpleLine = function (summary) {
	return A2(
		_Bractlet$elm_plot$Plot$fullLine,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$darkGrey),
			_1: {ctor: '[]'}
...
var _Bractlet$elm_plot$Plot$normalHintContainerInner = F2(
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background', _1: _Bractlet$elm_plot$Internal_Colors$grey},
								_1: {
									ctor: '::',
...
var _Bractlet$elm_plot$Plot$viewFlyingHintContainer = F4(
	function (inner, _p79, summary, hints) {
		var _p80 = _p79;
		var _p81 = _p80.x;
		var isLeft = _elm_lang$core$Native_Utils.cmp(
			_p81 - summary.x.min,
			_Bractlet$elm_plot$Internal_Draw$range(summary.x) / 2) > 0;
		var direction = isLeft ? 'translateX(-100%)' : 'translateX(0)';
		var xOffset = (A2(_Bractlet$elm_plot$Internal_Draw$toSVGX, summary, _p81) * 100) / summary.x.length;
		var style = {
			ctor: '::',
...
var _Bractlet$elm_plot$Plot$flyingHintContainer = F4(
	function (inner, hovering, summary, hints) {
		var _p82 = hovering;
		if (_p82.ctor === 'Nothing') {
			return _elm_lang$svg$Svg$text('');
		} else {
			return A4(_Bractlet$elm_plot$Plot$viewFlyingHintContainer, inner, _p82._0, summary, hints);
		}
	});
var _Bractlet$elm_plot$Plot$normalHintContainer = function (summary) {
...
var _Bractlet$elm_plot$Plot$junk = F3(
	function (title, x, y) {
		return {x: x, y: y, view: title};
	});
var _Bractlet$elm_plot$Plot$normalBarLabel = F2(
...
var _Bractlet$elm_plot$Plot$normalHint = function (y) {
	return A2(
...
var _Bractlet$elm_plot$Plot$rangeFrameDot = F3(
	function (view, x, y) {
		return {
			...
			xTick: _elm_lang$core$Maybe$Just(
				_Bractlet$elm_plot$Plot$simpleTick(x)),
			yTick: _elm_lang$core$Maybe$Just(
				_Bractlet$elm_plot$Plot$simpleTick(y)),
			hint: _elm_lang$core$Maybe$Nothing,
			x: x,
			y: y
		};
	});
var _Bractlet$elm_plot$Plot$emphasizedDot = F3(
	function (view, x, y) {
		return {
			view: _elm_lang$core$Maybe$Just(view),
...
var _Bractlet$elm_plot$Plot$onHovering = F3(
...
var _Bractlet$elm_plot$Plot$hintDot = F4(
	function (view, hovering, x, y) {
		return {
			view: _elm_lang$core$Maybe$Just(view),
			xLine: A3(
				_Bractlet$elm_plot$Plot$onHovering,
				_Bractlet$elm_plot$Plot$fullLine(
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$darkGrey),
			...
			hint: A3(
				_Bractlet$elm_plot$Plot$onHovering,
				_Bractlet$elm_plot$Plot$normalHint(y),
				hovering,
				x),
			x: x,
			y: y
...
var _Bractlet$elm_plot$Plot$dot = F3(
	function (view, x, y) {
		return {
			view: _elm_lang$core$Maybe$Just(view),
			xLine: _elm_lang$core$Maybe$Nothing,
...
var _Bractlet$elm_plot$Plot$clear = _Bractlet$elm_plot$Plot$dot(
	_elm_lang$svg$Svg$text(''));
var _Bractlet$elm_plot$Plot$triangle = _Bractlet$elm_plot$Plot$dot(
	_Bractlet$elm_plot$Plot$viewTriangle(_Bractlet$elm_plot$Internal_Colors$pinkStroke));
var _Bractlet$elm_plot$Plot$diamond = _Bractlet$elm_plot$Plot$dot(
	A3(_Bractlet$elm_plot$Plot$viewDiamond, 10, 10, _Bractlet$elm_plot$Internal_Colors$pinkStroke));
var _Bractlet$elm_plot$Plot$square = _Bractlet$elm_plot$Plot$dot(
	A2(_Bractlet$elm_plot$Plot$viewSquare, 10, _Bractlet$elm_plot$Internal_Colors$pinkStroke));
var _Bractlet$elm_plot$Plot$circle = _Bractlet$elm_plot$Plot$dot(
	A2(_Bractlet$elm_plot$Plot$viewCircle, 5, _Bractlet$elm_plot$Internal_Colors$pinkStroke));
var _Bractlet$elm_plot$Plot$PlotSummary = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _Bractlet$elm_plot$Plot$AxisSummary = F8(
	function (a, b, c, d, e, f, g, h) {
		return {min: a, max: b, dataMin: c, dataMax: d, marginLower: e, marginUpper: f, length: g, all: h};
	});
var _Bractlet$elm_plot$Plot$DataPoint = F8(
	function (a, b, c, d, e, f, g, h) {
		return {view: a, xLine: b, yLine: c, xTick: d, yTick: e, hint: f, x: g, y: h};
	});
var _Bractlet$elm_plot$Plot$customDot = _Bractlet$elm_plot$Plot$DataPoint;
var _Bractlet$elm_plot$Plot$Series = F3(
	function (a, b, c) {
		return {axis: a, interpolation: b, toDataPoints: c};
	});
var _Bractlet$elm_plot$Plot$customSeries = _Bractlet$elm_plot$Plot$Series;
var _Bractlet$elm_plot$Plot$Bars = F4(
	function (a, b, c, d) {
		return {axis: a, toGroups: b, styles: c, maxWidth: d};
	});
var _Bractlet$elm_plot$Plot$customGroups = _Bractlet$elm_plot$Plot$Bars;
var _Bractlet$elm_plot$Plot$BarGroup = F4(
	function (a, b, c, d) {
		return {label: a, hint: b, verticalLine: c, bars: d};
	});
var _Bractlet$elm_plot$Plot$customGroup = _Bractlet$elm_plot$Plot$BarGroup;
var _Bractlet$elm_plot$Plot$Bar = F2(
	function (a, b) {
		return {label: a, height: b};
	});
var _Bractlet$elm_plot$Plot$group = F2(
	function (label, heights) {
		return {
			label: _Bractlet$elm_plot$Plot$normalBarLabel(label),
			...
			bars: A2(
				_elm_lang$core$List$map,
				_Bractlet$elm_plot$Plot$Bar(_elm_lang$core$Maybe$Nothing),
				heights)
		};
	});
var _Bractlet$elm_plot$Plot$hintGroup = F3(
			...
			hint: function (g) {
				return A3(
					...
					A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Plot$normalHint, heights)),
					hovering,
					g);
			},
			bars: A2(
...
var _Bractlet$elm_plot$Plot$histogramBar = function (height) {
	return {
		label: _Bractlet$elm_plot$Plot$simpleLabel,
		verticalLine: _elm_lang$core$Basics$always(_elm_lang$core$Maybe$Nothing),
		hint: _elm_lang$core$Basics$always(_elm_lang$core$Maybe$Nothing),
		bars: {
			ctor: '::',
			_0: A2(_Bractlet$elm_plot$Plot$Bar, _elm_lang$core$Maybe$Nothing, height),
			_1: {ctor: '[]'}
		}
	};
};
var _Bractlet$elm_plot$Plot$PlotCustomizations = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _Bractlet$elm_plot$Plot$JunkCustomizations = F3(
	function (a, b, c) {
		return {x: a, y: b, view: c};
	});
var _Bractlet$elm_plot$Plot$GridLineCustomizations = F2(
	function (a, b) {
		return {attributes: a, position: b};
	});
var _Bractlet$elm_plot$Plot$AxisCustomizations = F5(
	function (a, b, c, d, e) {
		return {position: a, axisLine: b, ticks: c, labels: d, flipAnchor: e};
	});
var _Bractlet$elm_plot$Plot$LineCustomizations = F3(
	function (a, b, c) {
		return {attributes: a, start: b, end: c};
	});
var _Bractlet$elm_plot$Plot$TickCustomizations = F3(
	function (a, b, c) {
		return {attributes: a, length: b, position: c};
	});
var _Bractlet$elm_plot$Plot$LabelCustomizations = F2(
	function (a, b) {
		return {view: a, position: b};
	});
var _Bractlet$elm_plot$Plot$TempPlotSummary = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _Bractlet$elm_plot$Plot$Monotone = F2(
	function (a, b) {
		return {ctor: 'Monotone', _0: a, _1: b};
	});
var _Bractlet$elm_plot$Plot$Linear = F2(
	function (a, b) {
		return {ctor: 'Linear', _0: a, _1: b};
	});
var _Bractlet$elm_plot$Plot$None = {ctor: 'None'};
var _Bractlet$elm_plot$Plot$Fixed = function (a) {
	return {ctor: 'Fixed', _0: a};
};
var _Bractlet$elm_plot$Plot$Percentage = function (a) {
	return {ctor: 'Percentage', _0: a};
};
var _Bractlet$elm_plot$Plot$YeahGridsAreTotallyLame = {ctor: 'YeahGridsAreTotallyLame'};
var _Bractlet$elm_plot$Plot$clearGrid = _Bractlet$elm_plot$Plot$YeahGridsAreTotallyLame;
var _Bractlet$elm_plot$Plot$Grid = function (a) {
	return {ctor: 'Grid', _0: a};
};
var _Bractlet$elm_plot$Plot$customGrid = _Bractlet$elm_plot$Plot$Grid;
var _Bractlet$elm_plot$Plot$decentGrid = _Bractlet$elm_plot$Plot$customGrid(
	function (summary) {
		return A2(
			_elm_lang$core$List$map,
			_Bractlet$elm_plot$Plot$GridLineCustomizations(
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$grey),
					_1: {ctor: '[]'}
				}),
			_Bractlet$elm_plot$Plot$decentPositions(summary));
	});
var _Bractlet$elm_plot$Plot$SometimesYouDoNotHaveAnAxis = {ctor: 'SometimesYouDoNotHaveAnAxis'};
var _Bractlet$elm_plot$Plot$sometimesYouDoNotHaveAnAxis = _Bractlet$elm_plot$Plot$SometimesYouDoNotHaveAnAxis;
var _Bractlet$elm_plot$Plot$Axis = function (a) {
	return {ctor: 'Axis', _0: a};
};
var _Bractlet$elm_plot$Plot$customAxis = _Bractlet$elm_plot$Plot$Axis;
var _Bractlet$elm_plot$Plot$normalBarsAxis = _Bractlet$elm_plot$Plot$customAxis(
	function (summary) {
		return {
			position: _Bractlet$elm_plot$Plot$closestToZero,
			axisLine: _elm_lang$core$Maybe$Just(
				_Bractlet$elm_plot$Plot$simpleLine(summary)),
			ticks: A2(
				_elm_lang$core$List$map,
				_Bractlet$elm_plot$Plot$simpleTick,
				A3(_Bractlet$elm_plot$Plot$interval, 0, 1, summary)),
			labels: {ctor: '[]'},
			flipAnchor: false
		};
	});
var _Bractlet$elm_plot$Plot$normalAxis = _Bractlet$elm_plot$Plot$customAxis(
	function (summary) {
		return {
			position: _Bractlet$elm_plot$Plot$closestToZero,
			axisLine: _elm_lang$core$Maybe$Just(
			...
			ticks: A2(
				...
				_Bractlet$elm_plot$Plot$simpleTick,
				A2(
					_Bractlet$elm_plot$Plot$remove,
					0,
					_Bractlet$elm_plot$Plot$decentPositions(summary))),
			labels: A2(
				_elm_lang$core$List$map,
				_Bractlet$elm_plot$Plot$simpleLabel,
				A2(
					_Bractlet$elm_plot$Plot$remove,
					0,
					_Bractlet$elm_plot$Plot$decentPositions(summary))),
...
var _Bractlet$elm_plot$Plot$dots = function (toDataPoints) {
	return {axis: _Bractlet$elm_plot$Plot$normalAxis, interpolation: _Bractlet$elm_plot$Plot$None, toDataPoints: toDataPoints};
};
var _Bractlet$elm_plot$Plot$line = function (toDataPoints) {
	return {
		axis: _Bractlet$elm_plot$Plot$normalAxis,
		interpolation: A2(
			_Bractlet$elm_plot$Plot$Linear,
			_elm_lang$core$Maybe$Nothing,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$pinkStroke),
...
var _Bractlet$elm_plot$Plot$area = function (toDataPoints) {
	return {
		axis: _Bractlet$elm_plot$Plot$normalAxis,
		interpolation: A2(
			_Bractlet$elm_plot$Plot$Linear,
			_elm_lang$core$Maybe$Just(_Bractlet$elm_plot$Internal_Colors$pinkFill),
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$stroke(_Bractlet$elm_plot$Internal_Colors$pinkStroke),
				_1: {ctor: '[]'}
...
var _Bractlet$elm_plot$Plot$groups = function (toGroups) {
	return {
		axis: _Bractlet$elm_plot$Plot$normalAxis,
		toGroups: toGroups,
		styles: {
			...
			_0: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$fill(_Bractlet$elm_plot$Internal_Colors$pinkFill),
				_1: {ctor: '[]'}
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fill(_Bractlet$elm_plot$Internal_Colors$blueFill),
					_1: {ctor: '[]'}
				},
				_1: {ctor: '[]'}
			}
		},
		maxWidth: _Bractlet$elm_plot$Plot$Percentage(75)
	};
};
var _Bractlet$elm_plot$Plot$histogram = function (toGroups) {
	return {
		axis: _Bractlet$elm_plot$Plot$normalAxis,
		toGroups: toGroups,
		styles: {
		...
		maxWidth: _Bractlet$elm_plot$Plot$Percentage(100)
	};
};
var _Bractlet$elm_plot$Plot$defaultSeriesPlotCustomizations = {
	attributes: {ctor: '[]'},
	defs: {ctor: '[]'},
	id: 'elm-plot',
	width: 647,
	...
	hintContainer: _Bractlet$elm_plot$Plot$normalHintContainer,
	horizontalAxis: _Bractlet$elm_plot$Plot$normalAxis,
	grid: {horizontal: _Bractlet$elm_plot$Plot$clearGrid, vertical: _Bractlet$elm_plot$Plot$clearGrid},
...
var _Bractlet$elm_plot$Plot$defaultBarsPlotCustomizations = _elm_lang$core$Native_Utils.update(
	_Bractlet$elm_plot$Plot$defaultSeriesPlotCustomizations,
	{
		horizontalAxis: _Bractlet$elm_plot$Plot$normalBarsAxis,
		margin: {top: 20, right: 40, bottom: 40, left: 40}
	});
var _Bractlet$elm_plot$Plot$viewBars = _Bractlet$elm_plot$Plot$viewBarsCustom(_Bractlet$elm_plot$Plot$defaultBarsPlotCustomizations);
var _Bractlet$elm_plot$Plot$viewSeries = _Bractlet$elm_plot$Plot$viewSeriesCustom(_Bractlet$elm_plot$Plot$defaultSeriesPlotCustomizations);
var _Bractlet$elm_plot$Plot$clearAxis = _Bractlet$elm_plot$Plot$customAxis(
	function (summary) {
		return {
			position: _Bractlet$elm_plot$Plot$closestToZero,
...
var _Bractlet$elm_plot$Plot$axisAtMin = _Bractlet$elm_plot$Plot$customAxis(
	function (summary) {
		return {
...
var _Bractlet$elm_plot$Plot$axisAtMax = _Bractlet$elm_plot$Plot$customAxis(
	function (summary) {
		return {
...
var _user$project$Types$SetJson = function (a) {
	return {ctor: 'SetJson', _0: a};
};
...
var _user$project$View_Plot_Axis$axis = F6(
	function (showOnlyOneOnHover, hover, _p0, toValue, makeString, toTicks) {
		var _p1 = _p0;
		return _Bractlet$elm_plot$Plot$customAxis(
			function (summary) {
				...
				return {
					...
					ticks: showOnlyOneOnHover ? A4(_user$project$View_Plot_Axis$hoveredOrTicks, hover, toValue, _Bractlet$elm_plot$Plot$simpleTick, ticks) : A2(_elm_lang$core$List$map, _Bractlet$elm_plot$Plot$simpleTick, ticks),
...
var _user$project$View_Plot_Dot$flashyTick = F3(
	function (correctValue, toValue, hover) {
		return _elm_lang$core$Native_Utils.eq(
			...
			_Bractlet$elm_plot$Plot$simpleTick(correctValue)) : _elm_lang$core$Maybe$Nothing;
	});
...
var _user$project$View_Plot_Grid$grid = F4(
	function (gridLineFn, min, max, delta) {
		return _Bractlet$elm_plot$Plot$customGrid(
			function (summary) {
				return A2(
					_elm_lang$core$List$map,
					gridLineFn,
...
var _user$project$View_Plot_PlotCustomizations$plotCustomizations = F3(
	function (model, data, junk) {
		...
		return _elm_lang$core$Native_Utils.update(
			_Bractlet$elm_plot$Plot$defaultSeriesPlotCustomizations,
			{
				hintContainer: A2(_Bractlet$elm_plot$Plot$flyingHintContainer, _user$project$View_Plot_Hint$containerInner, model.hover),
				height: 300,
...
var _user$project$View_Plot_Type_AllInOne$allInOne = F2(
	function (model, data) {
		return {
			ctor: '::',
			_0: A3(
				_Bractlet$elm_plot$Plot$viewSeriesCustom,
				A3(
		...
		switch (_p5.ctor) {
			...
			case 'SetJson':
				...
				var newData = function () {
					var _p8 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Json$dataDecoder, _p9);
					if (_p8.ctor === 'Ok') {
						return _krisajenkins$remotedata$RemoteData$Success(_p8._0);
					} else {
						return _krisajenkins$remotedata$RemoteData$Failure(
							A2(
								_elm_lang$http$Http$BadPayload,
								_p8._0,
								{
									url: 'localjson',
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{data: newData}),
					_1: _user$project$Update$getCurrentTime
				};
			case 'FetchResult':
				return {
					ctor: '_Tuple2',
					...
					_1: _user$project$Update$saveSnapshot(
						{
							url: model.url,
							cookie: model.cookie,
							plot: _user$project$View_Plot$toString(_p10)
						})
				};
		}
	});
...
var _user$project$View$jsonInput = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$SetJson),
										_1: {ctor: '[]'}
									}
								}
							},
