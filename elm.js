					...
					function (_p2) {
						...
						return _elm_lang$core$Result$toMaybe(
							A3(
								...
								F2(
									function (d, s) {
										return {ctor: '_Tuple3', _0: d, _1: s, _2: _p3._1};
									}),
...
var _user$project$Update$decode = function (json) {
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'SetJson') {
			...
			return _elm_lang$core$Native_Utils.update(
				...
				{
					json: _p1,
					data: _user$project$Update$decode(_p1)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				...
				A2(
					...
					_elm_lang$core$List$maximum(
						A2(
							...
							function (_p0) {
								var _p1 = _p0;
								return _elm_lang$core$Date$toTime(_p1._2);
							},
							allCompletions)))));
		var maxDayStar = A2(
			_elm_lang$core$Maybe$withDefault,
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Update$initModel, update: _user$project$Update$update, view: _user$project$View$view})();
